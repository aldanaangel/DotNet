...
namespace TallerFinalNorthWind.menus
{
    class MenuProductos
    {
        public void mostrarMenuProductos()
        {
            ...
            menu = "MENÚ DE OPCIONES DEL GESTOR CRUD DE LA TABLA PRODUCTO \n" +
                         "1.  Insertar Registro \n" +
            ...
            CrudProducto ejecutarOpcionCrudProductos = new CrudProducto();
            
            do
            {
                Console.WriteLine(menu);
                opcion = Int32.Parse(System.Console.ReadLine());
                ejecutarOpcionCrudProductos.ejecutarOpcionProductos(opcion);
